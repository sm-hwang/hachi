...
def main():
    ...
    for oligo in f:
        ...
        mutated = [random.randrange(0, int(MUTATION_CHANCE ** -1)) for i in range(arg.oligo_size)] #generating list of random integers between 0 - (1/MUTATION_CHANCE). List size == oligo size in nt.
